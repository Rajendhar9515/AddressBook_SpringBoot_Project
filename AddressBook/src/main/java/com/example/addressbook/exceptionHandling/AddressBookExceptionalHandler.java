...
public class AddressBookExceptionalHandler {
        ...
        public ResponseEntity<ResponseDTO> handleMethodArgumentNotValidException(AddressBookException addressBookException){
            ResponseDTO responseDTO = new ResponseDTO("Exception while parsing rest request", addressBookException.getMessage());
            return new ResponseEntity<ResponseDTO>(responseDTO, HttpStatus.BAD_REQUEST);
        }
}
